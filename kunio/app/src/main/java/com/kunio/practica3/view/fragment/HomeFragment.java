package com.kunio.practica3.view.fragment;
...
import com.kunio.practica3.R;
import com.kunio.practica3.adapter.CardViewAdapter;
import com.kunio.practica3.model.Image;
...
public class HomeFragment extends Fragment {
    ...
    public ArrayList<Image> buidImages(){
        ...
        images.add(new Image("https://www.boliviaturismo.com.bo/imagenes/copacabana-bolivia.jpg", "Carlos Valdivia", "2 dias", "1 me gusta"));
        images.add(new Image("https://static.hosteltur.com/app/public/uploads/img/articles/2019/01/09/L_165028_fzc7069.jpg", "Luis Perez", "3 dias", "5 me gusta"));
        images.add(new Image("https://static.hosteltur.com/app/public/uploads/img/articles/2020/03/19/L_113715_la-paz-bolivia.jpg", "Laura Caceres", "6 dias", "3 me gusta"));
        ...
        images.add(new Image("https://www.periodicobolivia.com.bo/wp-content/uploads/2020/05/Que-cosas-ver-hacer-en-bolivia-lugares-sitios-puntos-destinos-turismo-dias.jpg", "Fernando Torrico", "6 dias", "4 me gusta"));
        images.add(new Image("https://americaxxi.com/wp-content/uploads/2019/12/BOLIVIA-Turismo-UyunI-2-610x259.jpg", "Maria FLores", "5 dias", "6 me gusta"));
